;(function ($, window, document) {
    ...
    ;(function () {
        ...
        var DateIdDom = document.querySelector('#dateId');
        ...
        var dateData = [
            ...
            {'id': '10001', 'value': '2018-05-01 (周二)'},
            {'id': '10002', 'value': '2018-05-02 (周三)'},
            {'id': '10003', 'value': '2018-05-03 (周四)'},
            {'id': '10004', 'value': '2018-05-04 (周五)'},
            {'id': '10005', 'value': '2018-05-05 (周六)'},
            {'id': '10006', 'value': '2018-05-06 (周日)'},
            {'id': '10007', 'value': '2018-05-07 (周一)'},
        ];

        var timeDataNor = [

            {'id': '10001', 'value': '9:00-10:00'},
            {'id': '10002', 'value': '10:00-11:00'},
            {'id': '10003', 'value': '11:00-12:00'},
            {'id': '10004', 'value': '12:00-13:00'},
            {'id': '10005', 'value': '13:00-14:00'},
            {'id': '10006', 'value': '14:00-15:00'},
            {'id': '10007', 'value': '15:00-16:00'},
        ];
        ...
        $('#showDate').click(function () {
            var dateId = showDateDom.dataset['id'];
            var dateName = showDateDom.dataset['value'];

            var dateSelect = new IosSelect(1, [dateData], {
                title: '配送日期',
                itemHeight: 0.933333,
                headerHeight: 1.18,
                cssUnit: 'rem',
                oneLevelId: dateId,
                callback: function (selectOneObj) {
                    DateIdDom.value = selectOneObj.id;
                    showDateDom.innerHTML = selectOneObj.value;
                    showDateDom.dataset['id'] = selectOneObj.id;
                    showDateDom.dataset['value'] = selectOneObj.value;
                    $('#showTime').html('请选择');
                    if(selectOneObj.id==='10003'||selectOneObj.id==='10004'){
                        timeData = timeDataSpe
                    }else {
                        timeData = timeDataNor;
                    }
                }
            })
        })
        ...
        $('#showTime').click(function () {
            ...
            var timeId = showTimeDom.dataset['id'];
            ...
            var timeSelect = new IosSelect(1, [timeData], {
                ...
                oneLevelId: timeId,
                callback: function (selectOneObj) {
                    timeIdDom.value = selectOneObj.id;
                    showTimeDom.innerHTML = selectOneObj.value;
                    showTimeDom.dataset['id'] = selectOneObj.id;
                    showTimeDom.dataset['value'] = selectOneObj.value;
                }
            })
        })
